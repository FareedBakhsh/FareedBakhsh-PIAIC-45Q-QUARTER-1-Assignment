...
if(alien_color4 === 'green'){
  console.log("Congrational ! the player earned 5 points.")
}else if(alien_color4 === "yellow"){
console.log("Congrational ! the player earned 10 points.")
}else if(alien_color4 === "red"){
  console.log("Congrational ! the player earned 15 points.")
  }
