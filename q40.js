...
function make_album(artistName, albumTitle, tracks) {
    //Creating the an objects describing a music album;
    return {
        artist: artistName,
        title: albumTitle,
        tracks: tracks,
...
//Creating the album;
const album1 = make_album('Fareed', 'The History of the Islam', ' ');
const album2 = make_album('Awais Qadri', 'Chly Madina', '');
const album3 = make_album('Rehmut Qadri', 'The Green Tomb Waly', '24'); //Including Tracks
// Print the albums
console.log(album1);
console.log(album2);
console.log(album3);
