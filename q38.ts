///Q38:Cities: Write a function called describe_city() that 
...
function describe_city( city :string ,country = 'Unkown'){
    console.log(`${city} is in ${country}`)
  }
  describe_city('Karachi','Pakistan');
  describe_city('NewYork','USA');
  describe_city('Istanbul')//Using default country values ("unkown")